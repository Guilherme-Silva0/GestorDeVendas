...
<div id="editSaleModal" class="hidden fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            class="inline-block bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 align-middle sm:max-w-xl md:max-w-2xl lg:max-w-3xl w-full">
                        ...
                        <div class="mt-2">
                            <form id="editSaleForm" method="POST" action="#">
                                ...
                                <div class="mt-2">
                                    ...
                                    <select id="edit_client" name="client_id" class="form-select mt-1 block w-full">
                                ...
                                <input type="hidden" name="products" id="edit_products">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input type="text" id="edit_total" name="total"
                                ...
                                <input type="hidden" name="installments" id="edit_installments">

                                <div class="mt-4 flex justify-end gap-1">
                                    <button onclick="closeEditSaleModal()" type="button"
