<div id="addClientModal" class="hidden fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
                            ...
                            <form id="clientForm" method="POST" action="#">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="cpf" name="cpf"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    <p id="cpfError" class="text-red-500 text-xs italic hidden">CPF inválido. Por
